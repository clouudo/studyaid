...
<body class="d-flex flex-column min-vh-100">
    ...
    <script>
        ...
        document.getElementById('noteForm').addEventListener('submit', async (e) => {
            ...
            // Show loading modal
            const loadingModal = new bootstrap.Modal(document.getElementById('noteLoadingModal'));
            loadingModal.show();
            ...
            try {
                ...
                if (json.success) {
                    // Hide loading modal
                    const loadingModalInstance = bootstrap.Modal.getInstance(document.getElementById('noteLoadingModal'));
    ...
    <!-- Loading Modal for Note Generation -->
    <div class="modal fade loading-modal" id="noteLoadingModal" tabindex="-1" aria-labelledby="noteLoadingModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="loading-spinner"></div>
                    <div class="loading-text">Generating Notes...</div>
